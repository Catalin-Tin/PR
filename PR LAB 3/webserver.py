...
tasks = [
    {
        ...
        'description': u'Is the worlds most popular programming language and is the programming language of the Web.',
        'done': False
    },
    {
        'id': 2,
        'title': u'Learn Python',
        'description': u'Is commonly used for developing websites and software, task automation, data analysis, '
                       u'and data visualization.',
        'done': False
    }
]
...
def update_task(task_id):
    ...
    if not request.json:
        abort(400)
    if 'title' in request.json and type(request.json['title']) != Scripts.unicode:
        abort(400)
    if 'description' in request.json and type(request.json['description']) is not Scripts.unicode:
        abort(400)
